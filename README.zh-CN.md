...
| 区域 | 内容 | 颜色逻辑 |
|------|------|----------|
| **模型** | 名称 + 思考/努力/快速/远程/代理标记 | Opus=品红, Sonnet=蓝, Haiku=青 |
| **上下文** | 进度条 + % + token 数量 | 绿色 <70%, 黄色 70-85%, 红色 >85% |
| **工作区** | 项目 + 相对路径 + git 分支 + 版本号 + vim + PR | — |
| **时长** | 经过时间 + 代码行变更 + 速率限制 | 速率：绿色 ≤59%, 黄色 60-84%, 红色 ≥85% |
...
| ⚡ | 快速模式活跃 | 区域 1 |
| 🌐 | 远程会话活跃 | 区域 1 |
| @name | 代理活跃（前 8 字符） | 区域 1 |
| #N | PR 编号 | 区域 3 |
| *tag* | 最新 git 标签（任何格式） | 区域 3 |
| [N] | Vim：NORMAL | 区域 3 |
| [I] | Vim：INSERT | 区域 3 |
| [V] | Vim：VISUAL | 区域 3 |
| [V-L] | Vim：VISUAL LINE | 区域 3 |
| +N/-N | 代码行增/删 | 区域 4 |
